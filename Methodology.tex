...
~\\
To profile the simulation, \\%explain the code to count the time
~\\
...
~\\
%insert table when data become available
...
~\\
%add a paragraph or 2 about the loops in mod_tendencies, profiling them, some data
OpenMP\\
Data dependencies\\
